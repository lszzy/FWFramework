...
@protocol __FWCollectionViewController <__FWViewController, UICollectionViewDataSource, UICollectionViewDelegate>
...
/**
 管理器集合视图控制器分类
 */
@interface __FWViewControllerManager (__FWCollectionViewController)
