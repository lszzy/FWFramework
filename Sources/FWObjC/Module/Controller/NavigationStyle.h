...
/// 应用指定导航栏配置
- (void)fw_applyBarAppearance:(__FWNavigationBarAppearance *)appearance NS_REFINED_FOR_SWIFT;

/// 应用指定导航栏样式
- (void)fw_applyBarStyle:(__FWNavigationBarStyle)style NS_REFINED_FOR_SWIFT;
...
@property (nullable, nonatomic, strong) __FWNavigationBarAppearance *fw_navigationBarAppearance NS_REFINED_FOR_SWIFT;

/// 当前导航栏样式，默认Default，设置后才会在viewWillAppear:自动应用生效
@property (nonatomic, assign) __FWNavigationBarStyle fw_navigationBarStyle NS_REFINED_FOR_SWIFT;
