...
extension Wrapper where Base: NSObject {
    ...
    public static func classMethods(_ clazz: AnyClass, superclass: Bool = false) -> [String] {
        ...
        if let cacheNames = NSObject.__classCaches[cacheKey] {
            return cacheNames
        }
        ...
        NSObject.__classCaches[cacheKey] = resultNames
        return resultNames
    }
    ...
    public var tempObject: Any? {
        get { return property(forName: "tempObject") }
        set { setProperty(newValue, forName: "tempObject") }
    }
    ...
    public func propertyBool(forName: String) -> Bool {
        if let number = property(forName: forName) as? NSNumber {
    ...
    public func setPropertyBool(_ value: Bool, forName: String) {
        setProperty(NSNumber(value: value), forName: forName)
    }
    ...
    private var allBoundObjects: NSMutableDictionary {
        if let boundObjects = property(forName: "boundObjects") as? NSMutableDictionary {
            return boundObjects
        }
        
        let boundObjects = NSMutableDictionary()
        setProperty(boundObjects, forName: "boundObjects")
        return boundObjects
    }
...
extension NSObject {
    ...
    fileprivate static var __classCaches: [String: [String]] = [:]
