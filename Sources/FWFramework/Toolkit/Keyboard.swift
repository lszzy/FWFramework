...
extension Wrapper where Base: UITextField {
    ...
    public weak var keyboardScrollView: UIScrollView? {
        get { return base.fw_keyboardScrollView }
        set { base.fw_keyboardScrollView = newValue }
    }
    ...
    public var returnNext: Bool {
        get { return base.fw_returnNext }
        set { base.fw_returnNext = newValue }
    }

    /// 设置点击键盘完成按钮的事件句柄
    public var returnBlock: ((UITextField) -> Void)? {
        get { return base.fw_returnBlock }
        set { base.fw_returnBlock = newValue }
    }
    
    // MARK: - Toolbar
    /// 获取关联的键盘Toolbar对象，可自定义样式
    public var keyboardToolbar: UIToolbar {
        get { return base.fw_keyboardToolbar }
        set { base.fw_keyboardToolbar = newValue }
    }

    /// 自定义键盘Toolbar上一个按钮，支持图片|字符串等(详见FWBlock)，默认朝上的箭头
    public var toolbarPreviousButton: Any? {
        get { return base.fw_toolbarPreviousButton }
        set { base.fw_toolbarPreviousButton = newValue }
    }

    /// 自定义键盘Toolbar下一个按钮，支持图片|字符串等(详见FWBlock)，默认朝下的箭头
    public var toolbarNextButton: Any? {
        get { return base.fw_toolbarNextButton }
        set { base.fw_toolbarNextButton = newValue }
    }

    /// 自定义键盘Toolbar完成按钮，支持图片|字符串等(详见FWBlock)，默认Done
    public var toolbarDoneButton: Any? {
        get { return base.fw_toolbarDoneButton }
        set { base.fw_toolbarDoneButton = newValue }
    }

    /// 设置Toolbar点击前一个按钮时聚焦的输入框句柄，默认nil
    public var previousResponder: ((UITextField) -> UIResponder?)? {
        get { return base.fw_previousResponder }
        set { base.fw_previousResponder = newValue }
    }

    /// 设置Toolbar点击下一个按钮时聚焦的输入框句柄，默认nil
    public var nextResponder: ((UITextField) -> UIResponder?)? {
        get { return base.fw_nextResponder }
        set { base.fw_nextResponder = newValue }
    }
    
    /// 设置Toolbar点击前一个按钮时聚焦的输入框tag，默认0不生效
    public var previousResponderTag: Int {
        get { return base.fw_previousResponderTag }
        set { base.fw_previousResponderTag = newValue }
    }

    /// 设置Toolbar点击下一个按钮时聚焦的输入框tag，默认0不生效
    public var nextResponderTag: Int {
        get { return base.fw_nextResponderTag }
        set { base.fw_nextResponderTag = newValue }
    }
    ...
    public func keyboardHeight(_ notification: Notification) -> CGFloat {
        return base.fw_keyboardHeight(notification)
    }
    ...
    public func keyboardAnimate(_ notification: Notification, animations: @escaping () -> Void, completion: ((Bool) -> Void)? = nil) {
        base.fw_keyboardAnimate(notification, animations: animations, completion: completion)
    }
    ...
    public func addToolbar(titleItem: UIBarButtonItem?, previousItem: UIBarButtonItem?, nextItem: UIBarButtonItem?, doneItem: UIBarButtonItem?) {
        base.fw_addToolbar(titleItem: titleItem, previousItem: previousItem, nextItem: nextItem, doneItem: doneItem)
    }
}
...
extension Wrapper where Base: UITextView {
    ...
    public weak var delegate: UITextViewDelegate? {
        get { return base.fw_delegate }
        set { base.fw_delegate = newValue }
    }
...
extension Wrapper where Base: UITextView {
    ...
    public var placeholder: String? {
        get { return base.fw_placeholder }
        set { base.fw_placeholder = newValue }
    }
    ...
    public var attributedPlaceholder: NSAttributedString? {
        get { return base.fw_attributedPlaceholder }
        set { base.fw_attributedPlaceholder = newValue }
    }

    /// 自定义占位文本内间距，默认zero与内容一致
    public var placeholderInset: UIEdgeInsets {
        get { return base.fw_placeholderInset }
        set { base.fw_placeholderInset = newValue }
    }
    ...
    public var autoHeightEnabled: Bool {
        get { return base.fw_autoHeightEnabled }
        set { base.fw_autoHeightEnabled = newValue }
    }

    /// 最大高度，默认CGFLOAT_MAX，启用自动高度后生效
    public var maxHeight: CGFloat {
        get { return base.fw_maxHeight }
        set { base.fw_maxHeight = newValue }
    }

    /// 最小高度，默认0，启用自动高度后生效
    public var minHeight: CGFloat {
        get { return base.fw_minHeight }
        set { base.fw_minHeight = newValue }
    }

    /// 高度改变回调句柄，默认nil，启用自动高度后生效
    public var heightDidChange: ((CGFloat) -> Void)? {
        get { return base.fw_heightDidChange }
        set { base.fw_heightDidChange = newValue }
    }

    /// 快捷启用自动高度，并设置最大高度和回调句柄
    public func autoHeight(maxHeight: CGFloat, didChange: ((CGFloat) -> Void)?) {
        base.fw_autoHeight(maxHeight: maxHeight, didChange: didChange)
    }
}
...
@_spi(FW) extension UITextField {
    ...
    // MARK: - Keyboard
    /// 是否启用键盘管理(自动滚动)，默认NO
    @objc dynamic public var fw_keyboardManager: Bool {
...
@_spi(FW) extension UITextView {
    ...
    var fw_placeholderLineHeight: CGFloat {
        get {
            return self.fw_placeholderLabel.fw_lineHeight
        }
        set {
