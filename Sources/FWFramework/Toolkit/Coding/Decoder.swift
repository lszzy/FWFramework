...
extension Wrapper where Base == Data {
    ...
    public var base64Decode: Data? {
        Data(base64Encoded: base, options: .ignoreUnknownCharacters)
    }
}
...
extension Wrapper where Base == String {
    ...
    public var urlEncodeComponent: String? {
        base.addingPercentEncoding(withAllowedCharacters: CharacterSet(charactersIn: "!*'();:@&=+$,/?%#[]").inverted)
    }
    ...
    public var urlDecodeComponent: String? {
        CFURLCreateStringByReplacingPercentEscapes(nil, base as CFString, "" as CFString) as String?
    }
