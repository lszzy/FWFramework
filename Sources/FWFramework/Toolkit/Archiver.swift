...
public class ArchiveCoder: NSObject, NSSecureCoding {
    ...
    public var archivableObject: Any? {
        get {
            ...
            var objectType = ArchiveCoder.registeredTypes.object[archiveType]
            if objectType == nil {
