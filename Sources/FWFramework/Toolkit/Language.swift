...
extension WrapperGlobal {
    ...
    public static func localized(_ key: String, _ table: String? = nil) -> String {
        Bundle.fw.localizedString(key, table: table)
    }
}
...
extension Wrapper where Base == String {
    ...
    public var localized: String {
        Bundle.fw.localizedString(base)
    }
    ...
    public func localized(_ bundle: Bundle?) -> String {
        Bundle.fw.localizedString(base, bundle: bundle)
    }
    ...
    public func localized(_ table: String?, _ bundle: Bundle? = nil) -> String {
        Bundle.fw.localizedString(base, table: table, bundle: bundle)
    }
}
...
extension Wrapper where Base: Bundle {
    ...
    public static var currentLanguage: String? {
        localizedLanguage ?? systemLanguage
    }
    ...
    public static var systemLanguage: String? {
        get {
            if let language = LanguageConfiguration.systemLanguage {
                return language
            }
            return Bundle.main.preferredLocalizations.first
        }
        set {
            LanguageConfiguration.systemLanguage = newValue
        }
    }
    ...
    public static var localizedLanguage: String? {
        get {
            if let language = LanguageConfiguration.localizedLanguage {
                return !language.isEmpty ? language : nil
            }
            let language = UserDefaults.standard.string(forKey: "FWLocalizedLanguage")
            LanguageConfiguration.localizedLanguage = language ?? ""
            return language
        }
        set {
            LanguageConfiguration.localizedLanguage = newValue ?? ""
    ...
    public static func bundle(with clazz: AnyClass, name: String?) -> Bundle? {
        ...
        guard let name, !name.isEmpty else { return bundle }
    ...
    public static func localizedString(_ key: String, bundle: Bundle?) -> String {
        localizedString(key, table: nil, bundle: bundle)
    }
    ...
    public var executableName: String {
        base.executableURL?.lastPathComponent ?? ""
    }
}
...
private actor LanguageConfiguration {
    static var systemLanguage: String?
    static var localizedLanguage: String?
}
