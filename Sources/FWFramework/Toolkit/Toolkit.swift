...
extension Wrapper where Base: UIApplication {
    ...
    @MainActor public static func beginBackgroundTask(_ task: (@escaping () -> Void) -> Void, expirationHandler: (() -> Void)? = nil) {
...
extension UIFont {
    ...
    nonisolated(unsafe) fileprivate static var innerAutoScaleBlock: (@MainActor @Sendable (CGFloat) -> CGFloat)?
