...
open class FloatLayoutView: UIView {
    ...
    @IBInspectable open var maximumItemSize: CGSize = FloatLayoutView.automaticalMaximumItemSize
    ...
    private func layoutSubviews(size: CGSize, shouldLayout: Bool) -> CGSize {
        ...
        let maximumItemSize = (maximumItemSize == FloatLayoutView.automaticalMaximumItemSize) ? CGSize(width: size.width - (padding.left + padding.right), height: size.height - (padding.top + padding.bottom)) : maximumItemSize
        var line: Int = -1
