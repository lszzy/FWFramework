...
open class ImagePreviewTransitionAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    nonisolated(unsafe) open var animationEnteringBlock: (@MainActor @Sendable (_ animator: ImagePreviewTransitionAnimator, _ isPresenting: Bool, _ style: ImagePreviewTransitioningStyle, _ sourceImageRect: CGRect, _ zoomImageView: ZoomImageView, _ transitionContext: UIViewControllerContextTransitioning?) -> Void)?
    ...
    /// zoomImageView 当前图片
    /// transitionContext 转场动画的上下文，可通过它获取前后界面、动画容器等信息
    nonisolated(unsafe) open var animationBlock: (@MainActor @Sendable (_ animator: ImagePreviewTransitionAnimator, _ isPresenting: Bool, _ style: ImagePreviewTransitioningStyle, _ sourceImageRect: CGRect, _ zoomImageView: ZoomImageView, _ transitionContext: UIViewControllerContextTransitioning?) -> Void)?
    ...
    /// zoomImageView 当前图片
    /// transitionContext 转场动画的上下文，可通过它获取前后界面、动画容器等信息
    nonisolated(unsafe) open var animationCompletionBlock: (@MainActor @Sendable (_ animator: ImagePreviewTransitionAnimator, _ isPresenting: Bool, _ style: ImagePreviewTransitioningStyle, _ sourceImageRect: CGRect, _ zoomImageView: ZoomImageView, _ transitionContext: UIViewControllerContextTransitioning?) -> Void)?
    ...
    nonisolated(unsafe) open var animationCallbackBlock: (@MainActor @Sendable (_ animator: ImagePreviewTransitionAnimator, _ isPresenting: Bool, _ isFinished: Bool) -> Void)?
