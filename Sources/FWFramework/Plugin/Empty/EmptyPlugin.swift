...
@MainActor extension Wrapper where Base: UIView {
    ...
    public func showEmptyView(
        error: Error?,
        action: AttributedStringParameter? = nil,
        block: (@MainActor @Sendable (Any) -> Void)? = nil
    ) {
        showEmptyView(
    ...
    public func showEmptyView(
        ...
        detail: AttributedStringParameter?,
        image: UIImage?,
        loading: Bool,
        action: AttributedStringParameter?,
        block: (@MainActor @Sendable (Any) -> Void)?,
...
extension FrameworkAutoloader {
    private nonisolated(unsafe) static var emptyPluginSwizzled = false

    fileprivate static func swizzleEmptyPlugin() {
        guard !emptyPluginSwizzled else { return }
        emptyPluginSwizzled = true
