...
extension Wrapper where Base: NSObject {
    ...
    public static func swizzleDeallocMethod<T: NSObject>(
        ...
        return Base.fw_swizzleDeallocMethod(originalClass, identifier: identifier, block: block)
    }
    ...
    public static func swizzleVoidMethod<T: NSObject>(
        ...
        return Base.fw_swizzleVoidMethod(originalClass, selector: selector, identifier: identifier, block: block)
    }
