...
open class FloatView: UIView {
    ...
    @IBInspectable open var maximumItemSize: CGSize = FloatView.automaticalMaximumItemSize
    ...
    private func layoutSubviews(size: CGSize, shouldLayout: Bool) -> CGSize {
        ...
        let maximumItemSize = (maximumItemSize == FloatView.automaticalMaximumItemSize) ? CGSize(width: size.width - (padding.left + padding.right), height: size.height - (padding.top + padding.bottom)) : maximumItemSize
        var line: Int = -1
