...
/**
 *  parameters 里内置的几个参数会用到上面定义的 string
 */
typedef void (^FWRouterHandler)(NSDictionary *parameters);

/**
 *  需要返回一个 parameters，配合 objectForURL: 使用
 */
 ...
 *
 *  @param pattern    带上 scheme，如 mgj://beauty/:id
 ...
 *
 *  #define FW_ROUTE_BEAUTY @"beauty/:id"
 *  [FWRouter generateURL:MGJ_ROUTE_BEAUTY, @[@13]];
 *
 *
