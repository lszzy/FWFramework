...
/*!
 ...
 @param block  消息句柄
 */
- (void)fwObserveMessage:(NSString *)name object:(id)object block:(void (^)(NSNotification *notification))block;
...
/*!
 ...
 @param block  通知句柄
 */
- (void)fwObserveNotification:(NSString *)name object:(id)object block:(void (^)(NSNotification *notification))block;
