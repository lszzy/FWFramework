...
typedef NS_ERROR_ENUM(FWAsyncUdpSocketErrorDomain, FWAsyncUdpSocketError) {
	...
	FWAsyncUdpSocketBadConfigError,       // Invalid configuration
	FWAsyncUdpSocketBadParamError,        // Invalid parameter was passed
 ...
 * 
 * This means FWAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, FWAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, FWAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, FWAsyncUdpSocket will automatically use IPv6.
...
**/
- (void)setSendFilter:(nullable FWAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable FWAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable FWAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
