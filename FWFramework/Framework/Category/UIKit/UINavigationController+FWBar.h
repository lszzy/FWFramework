...
/*!
 @brief 优化导航栏转场动画突兀的问题，默认关闭。全局启用后各个ViewController管理自己的导航栏样式，viewDidLoad中设置即可
...
// 全局启用转场NavigationBar，只能启用一次，多次启用不生效。启用后各个ViewController管理自己的导航栏样式，viewDidLoad中设置即可
