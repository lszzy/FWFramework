...
/*!
 @brief 优化导航栏转场动画突兀的问题，默认关闭。全局启用后各个ViewController管理自己的导航栏样式，viewDidLoad中设置即可；启用后不建议使用appearance设置导航栏背景
...
// 全局启用转场NavigationBar。启用后各个ViewController管理自己的导航栏样式，viewDidLoad中设置即可；启用后不建议使用appearance设置导航栏背景
