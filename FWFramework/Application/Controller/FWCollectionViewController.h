...
// 集合视图，默认不显示滚动条
@property (nonatomic, readonly) UICollectionView *collectionView NS_REFINED_FOR_SWIFT;

// 集合数据，默认空数组，延迟加载
@property (nonatomic, readonly) NSMutableArray *collectionData NS_REFINED_FOR_SWIFT;
