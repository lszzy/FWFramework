...
- (void)setFadeWidthPercent:(CGFloat)fadeWidthPercent {
    if (!(0.0 <= fadeWidthPercent && fadeWidthPercent <= 1.0)) {
        return;
    }
...
- (void)drawTextInRect:(CGRect)rect {
    ...
    if (self.textAlignment == NSTextAlignmentLeft) {
        ...
        CGFloat floatValue = (CGRectGetWidth(self.bounds) - self.textWidth) / 2.0;
        floatValue = (floatValue == CGFLOAT_MIN) ? 0 : floatValue;
        CGFloat scale = ([[UIScreen mainScreen] scale]);
        CGFloat flattedValue = ceil(floatValue * scale) / scale;
        textInitialX = fmax(0, flattedValue);
...
- (void)checkIfShouldShowGradientLayer {
    ...
    if (shouldShowFadeLayer) {
        ...
        self.fadeLayer.colors = @[(id)[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.0].CGColor, (id)[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0].CGColor, (id)[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0].CGColor, (id)[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.0].CGColor];
