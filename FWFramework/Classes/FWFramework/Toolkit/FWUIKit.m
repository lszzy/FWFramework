...
- (void)setImageEdge:(UIRectEdge)edge spacing:(CGFloat)spacing
{
    ...
    switch (edge) {
        ...
        case UIRectEdgeRight:
            ...
            break;
        case UIRectEdgeTop:
            self.base.imageEdgeInsets = UIEdgeInsetsMake(-labelSize.height - spacing / 2.0, 0, 0, -labelSize.width);
            self.base.titleEdgeInsets = UIEdgeInsetsMake(0, -imageSize.width, -imageSize.height - spacing / 2.0, 0);
            break;
        case UIRectEdgeBottom:
            self.base.imageEdgeInsets = UIEdgeInsetsMake(0, 0, -labelSize.height - spacing / 2.0, -labelSize.width);
            self.base.titleEdgeInsets = UIEdgeInsetsMake(-imageSize.height - spacing / 2.0, -imageSize.width, 0, 0);
            break;
        default:
            break;
    }
