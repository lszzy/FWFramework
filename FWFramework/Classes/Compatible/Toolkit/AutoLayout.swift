...
public class LayoutChain {
    ...
    public func center() -> Self {
        view?.__fw.alignCenterToSuperview()
        return self
    }

    @discardableResult
    public func centerX() -> Self {
        view?.__fw.alignAxis(toSuperview: .centerX)
        return self
    }

    @discardableResult
    public func centerY() -> Self {
        view?.__fw.alignAxis(toSuperview: .centerY)
        return self
    }
    ...
    public func edgesHorizontal() -> Self {
        view?.__fw.pinEdgesToSuperviewHorizontal()
        return self
    }

    @discardableResult
    public func edgesVertical() -> Self {
        view?.__fw.pinEdgesToSuperviewVertical()
        return self
    }
    ...
    public func edgesToSafeAreaHorizontal() -> Self {
        view?.__fw.pinEdgesToSuperviewSafeAreaHorizontal()
        return self
    }

    @discardableResult
    public func edgesToSafeAreaVertical() -> Self {
        view?.__fw.pinEdgesToSuperviewSafeAreaVertical()
        return self
    }
