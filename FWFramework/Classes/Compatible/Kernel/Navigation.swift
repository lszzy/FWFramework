...
extension Wrapper where Base: UIWindow {
    ...
    public func open(_ viewController: UIViewController, options: NavigationOptions = [], animated: Bool = true, completion: (() -> Void)? = nil) {
        base.__fw_open(viewController, options: options, animated: animated, completion: completion)
    }
    ...
    /// 使用最顶部的视图控制器打开控制器，自动判断push|present
    public static func open(_ viewController: UIViewController, options: NavigationOptions = [], animated: Bool = true, completion: (() -> Void)? = nil) {
        Base.__fw_open(viewController, options: options, animated: animated, completion: completion)
    }
