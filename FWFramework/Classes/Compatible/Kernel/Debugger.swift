...
extension Wrapper where Base: UIView {
    ...
    public var viewInfo: String {
        return base.__fw.viewInfo
    }

    /// 是否需要添加debug背景色，默认NO
    public var showDebugColor: Bool {
        get { return base.__fw.showDebugColor }
        set { base.__fw.showDebugColor = newValue }
    }

    /// 是否每个view的背景色随机，如果不随机则统一使用半透明红色，默认NO
    public var randomDebugColor: Bool {
        get { return base.__fw.randomDebugColor }
        set { base.__fw.randomDebugColor = newValue }
    }

    /// 是否需要添加debug边框，默认NO
    public var showDebugBorder: Bool {
        get { return base.__fw.showDebugBorder }
        set { base.__fw.showDebugBorder = newValue }
    }

    /// 指定debug边框的颜色，默认半透明红色
    public var debugBorderColor: UIColor {
        get { return base.__fw.debugBorderColor }
        set { base.__fw.debugBorderColor = newValue }
    }
}
...
extension Wrapper where Base: UILabel {
    ...
    public var showPrincipalLines: Bool {
        get { return base.__fw.showPrincipalLines }
        set { base.__fw.showPrincipalLines = newValue }
    }
    ...
    public var principalLineColor: UIColor {
        get { return base.__fw.principalLineColor }
        set { base.__fw.principalLineColor = newValue }
    }
}
