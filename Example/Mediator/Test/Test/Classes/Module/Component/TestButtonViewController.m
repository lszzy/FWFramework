...
- (void)renderView
{
    UIButton *button = [UIButton fwButtonWithFont:[UIFont fwFontOfSize:15] titleColor:[UIColor blackColor] title:@"Button重复点击"];
    button.frame = CGRectMake(20, 20, 200, 50);
    [button fwAddTouchTarget:self action:@selector(onClick1:)];
    [self.view addSubview:button];
    
    UILabel *label = [UILabel fwLabelWithFont:[UIFont fwFontOfSize:15] textColor:[UIColor blackColor] text:@"View重复点击"];
    ...
    button = [UIButton fwButtonWithFont:[UIFont fwFontOfSize:15] titleColor:[UIColor blackColor] title:@"Button不可重复点击"];
    button.frame = CGRectMake(20, 160, 200, 50);
    [button fwAddTouchTarget:self action:@selector(onClick3:)];
    [self.view addSubview:button];
    
    label = [UILabel fwLabelWithFont:[UIFont fwFontOfSize:15] textColor:[UIColor blackColor] text:@"View不可重复点击"];
    label.textAlignment = NSTextAlignmentCenter;
    label.userInteractionEnabled = YES;
    ...
    button = [UIButton fwButtonWithFont:[UIFont fwFontOfSize:15] titleColor:[UIColor blackColor] title:@"Button1秒内不可重复点击"];
    ...
    [timerButton1 setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    ...
    [timerButton2 setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
