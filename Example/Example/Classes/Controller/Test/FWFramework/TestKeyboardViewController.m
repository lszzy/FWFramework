...
- (void)renderView
{
    ...
    mobileField.fwTouchResign = YES;
    mobileField.fwKeyboardManager = YES;
    ...
    passwordField.fwTouchResign = YES;
    passwordField.fwKeyboardManager = YES;
    ...
    textView.fwTouchResign = YES;
    textView.fwKeyboardManager = YES;
