...
- (void)renderView
{
    ...
    [textField fwSetBorderColor:[UIColor appColorHex:0xDDDDDD] width:0.5 cornerRadius:5];
    _textField = textField;
    textField.delegate = self;
    [self.view addSubview:textField];
    textField.fwLayoutChain.leftWithInset(50).rightWithInset(50).topWithInset(200).height(45);
    
    UILabel *customLabel = [UILabel fwLabelWithFont:[UIFont appFontSize:16] textColor:[UIColor appColorBlackOpacityHuge] text:@"我是自定义标签"];
    _customCellView = customLabel;
    customLabel.backgroundColor = [UIColor appColorMain];
