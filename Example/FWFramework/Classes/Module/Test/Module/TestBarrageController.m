...
#import "TestBarrageController.h"
#import "AppSwift.h"
@import FWFramework;
...
- (void)updateSubviewsData {
    ...
    [self.leftImageView setImage:[UIImage fw_appIconImage]];
    [self.middleImageView setBackgroundColor:[UIColor colorWithRed:1.00 green:0.83 blue:0.26 alpha:1.00]];
    [self.rightImageView setImage:[UIImage fw_appIconImage]];
}
...
@interface TestBarrageController () <FWViewController>
...
@implementation TestBarrageController
...
- (void)viewDidLoad {
    ...
    self.view.fw_height = FWScreenHeight - FWTopBarHeight;
    ...
    [button2 setTitleColor:[AppTheme textColor] forState:UIControlStateNormal];
    ...
    [button3 setTitleColor:[AppTheme textColor] forState:UIControlStateNormal];
    ...
    [button4 setTitleColor:[AppTheme textColor] forState:UIControlStateNormal];
...
- (void)addNormalBarrage {
    ...
    textDescriptor.text = [NSString stringWithFormat:@"~弹幕~"];
    textDescriptor.textColor = [AppTheme textColor];
    textDescriptor.positionPriority = FWBarragePositionLow;
    textDescriptor.textFont = [UIFont systemFontOfSize:17.0];
    textDescriptor.strokeColor = [[AppTheme textColor] colorWithAlphaComponent:0.3];
...
- (void)addFixedSpeedAnimationCell {
    ...
    gradientBackgroundDescriptor.textColor = [AppTheme textColor];
    ...
    gradientBackgroundDescriptor.strokeColor = [[AppTheme textColor] colorWithAlphaComponent:0.3];
    gradientBackgroundDescriptor.strokeWidth = -1;
    gradientBackgroundDescriptor.fixedSpeed = 50.0;
    gradientBackgroundDescriptor.barrageCellClass = [FWBarrageGradientBackgroundColorCell class];
    gradientBackgroundDescriptor.gradientColor = UIColor.fw_randomColor;
...
- (void)addWalkBannerBarrage {
    ...
    bannerDescriptor.cellTouchedAction = ^(FWBarrageDescriptor *__weak descriptor, FWBarrageCell *__weak cell) {
        FWIgnoredBegin();
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"弹幕" message:@"为您服务" delegate:nil cancelButtonTitle:@"朕知道了" otherButtonTitles:nil];
        [alertView show];
        FWIgnoredEnd();
    ...
    bannerDescriptor.text = [NSString stringWithFormat:@"~欢迎大驾光临~"];
    bannerDescriptor.textColor = [AppTheme textColor];
    bannerDescriptor.textFont = [UIFont systemFontOfSize:17.0];
    bannerDescriptor.positionPriority = FWBarragePositionMiddle;
    bannerDescriptor.strokeColor = [[AppTheme textColor] colorWithAlphaComponent:0.3];
...
- (void)addStopoverBarrage {
    ...
    NSMutableAttributedString *mAttributedString = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"~荣誉出品~"]];
    [mAttributedString addAttribute:NSForegroundColorAttributeName value:[AppTheme textColor] range:NSMakeRange(0, mAttributedString.length)];
    [mAttributedString addAttribute:NSForegroundColorAttributeName value:[UIColor greenColor] range:NSMakeRange(1, 2)];
    [mAttributedString addAttribute:NSForegroundColorAttributeName value:[UIColor cyanColor] range:NSMakeRange(3, 2)];
    ...
    becomeNobleDescriptor.backgroundImage = [UIImage fw_appIconImage];
...
- (void)addVerticalAnimationCell {
    ...
    verticalTextDescriptor.textColor = [AppTheme textColor];
    verticalTextDescriptor.positionPriority = FWBarragePositionLow;
    verticalTextDescriptor.textFont = [UIFont systemFontOfSize:17.0];
    verticalTextDescriptor.strokeColor = [[AppTheme textColor] colorWithAlphaComponent:0.3];
...
- (void)addGifBarrage {
    ...
    UIImage *image = [FWModuleBundle imageNamed:@"Loading.gif"];
