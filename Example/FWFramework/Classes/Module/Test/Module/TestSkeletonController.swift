...
class TestSkeletonController: UIViewController, TableViewControllerProtocol, SkeletonViewDelegate {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        tableView.app.height(cellClass: TestSkeletonCell.self) { [weak self] cell in
    ...
    func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        tableView.app.height(headerFooterViewClass: TestSkeletonHeaderView.self, type: .header) { headerView in
            headerView.configure(object: "1")
        }
    }
    ...
    func tableView(_ tableView: UITableView, heightForFooterInSection section: Int) -> CGFloat {
        tableView.app.height(headerFooterViewClass: TestSkeletonFooterView.self, type: .footer) { footerView in
            footerView.configure(object: "1")
        }
    }

    func skeletonViewLayout(_ layout: SkeletonLayout) {
        layout.setScrollView(tableView)

        if scrollStyle == 0 {
            if let tableView = layout.addSkeletonView(tableView) as? SkeletonTableView {
            ...
            if let tableView = SkeletonLayout.parseSkeletonView(tableView) as? SkeletonTableView {
                tableView.tableDelegate.cellClass = TestSkeletonCell.self
