...
class TestBannerController: UIViewController, ViewControllerProtocol, BannerViewDelegate {
    ...
    var titlesGroup: [Any] = ["1", "2", "3", NSAttributedString(string: "4", attributes: [.foregroundColor: UIColor.app.randomColor]), NSAttributedString(string: "5", attributes: [.foregroundColor: UIColor.app.randomColor]), NSAttributedString(string: "6", attributes: [.foregroundColor: UIColor.app.randomColor])]
