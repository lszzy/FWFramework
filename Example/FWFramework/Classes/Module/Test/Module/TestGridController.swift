...
class TestGridController: UIViewController, ViewControllerProtocol {
    ...
    func setupSubviews() {
        ...
        gridView.fw.layoutChain
            .edges(toSafeArea: UIEdgeInsets(top: 24, left: 24, bottom: 24, right: 24), excludingEdge: .bottom)
        
        let themeColors = [UIColor.fw.randomColor, UIColor.fw.randomColor, UIColor.fw.randomColor, UIColor.fw.randomColor, UIColor.fw.randomColor, UIColor.fw.randomColor, UIColor.fw.randomColor, UIColor.fw.randomColor]
