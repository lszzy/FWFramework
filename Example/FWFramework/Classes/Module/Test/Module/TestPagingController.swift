...
class TestPagingController: UIViewController, ViewControllerProtocol, PagingViewDelegate {
    ...
    func tableHeaderViewHeight(in pagingView: PagingView) -> Int {
        Int(TestPagingController.headerViewHeight)
    }
    ...
    func heightForPinSectionHeader(in pagingView: PagingView) -> Int {
        Int(TestPagingController.segmentViewHeight)
    }
    ...
    func numberOfLists(in pagingView: PagingView) -> Int {
        segmentedControl.sectionTitles.count
    }
    ...
    func pagingView(_ pagingView: PagingView, initListAtIndex index: Int) -> PagingViewListViewDelegate {
        ...
        listView.refreshList = refreshList
        listView.isRefreshed = isRefreshed
        if index == 0 {
            listView.rows = 30
    ...
    func pagingView(_ pagingView: PagingView, didScrollToIndex index: Int) {
        ...
        if !pagerView.isHidden {
            cartView.isHidden = index != 0
        }
    }
}
...
class TestNestChildController: UIViewController, TableViewControllerProtocol, CollectionViewControllerProtocol, PagingViewListViewDelegate {
    ...
    func setupTableLayout() {
        tableView.layoutChain.edges(UIEdgeInsets(top: 0, left: cart ? TestPagingController.categoryViewWidth : 0, bottom: cart ? TestPagingController.cartViewHeight : 0, right: 0))
    }
    ...
    func setupLayout() {
        ...
        tableView.app.reloadData { [weak self] in
            ...
            selectCollectionView(offset: tableView.contentOffset.y)
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        Int(ceil(Double(tableData.count) / 5.0))
    }
    ...
    func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        self.section ? TestPagingController.itemViewHeight : 0
    }
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        TestPagingController.itemViewHeight
    }
